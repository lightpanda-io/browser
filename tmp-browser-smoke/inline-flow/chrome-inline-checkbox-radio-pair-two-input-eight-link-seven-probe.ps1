...
$outPng = Join-Path $root "checkbox-radio-pair-two-input-eight-link-seven.png"
$browserOut = Join-Path $root "checkbox-radio-pair-two-input-eight-link-seven.browser.stdout.txt"
$browserErr = Join-Path $root "checkbox-radio-pair-two-input-eight-link-seven.browser.stderr.txt"
$serverOut = Join-Path $root "checkbox-radio-pair-two-input-eight-link-seven.server.stdout.txt"
$serverErr = Join-Path $root "checkbox-radio-pair-two-input-eight-link-seven.server.stderr.txt"
...
try {
  ...
  $profileRoot = Join-Path $root "profile-inline-checkbox-radio-pair-two-input-eight-link-seven"
