...
$outPng = Join-Path $root "checkbox-radio-pair-two-input-four-link-four.png"
$browserOut = Join-Path $root "checkbox-radio-pair-two-input-four-link-four.browser.stdout.txt"
$browserErr = Join-Path $root "checkbox-radio-pair-two-input-four-link-four.browser.stderr.txt"
$serverOut = Join-Path $root "checkbox-radio-pair-two-input-four-link-four.server.stdout.txt"
$serverErr = Join-Path $root "checkbox-radio-pair-two-input-four-link-four.server.stderr.txt"
...
try {
  ...
  $profileRoot = Join-Path $root "profile-inline-checkbox-radio-pair-two-input-four-link-four"
...
"@ | Set-Content -Path (Join-Path $appDataRoot "browse-settings-v1.txt") -NoNewline
  ...
  if (-not $inputTwoWorked) { throw "inline checkbox radio pair two input four-link fourth probe second input did not update after typing" }
