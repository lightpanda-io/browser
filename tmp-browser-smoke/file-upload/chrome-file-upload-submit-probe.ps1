...
try {
  ...
  $serverSawUpload = Wait-FileUploadLogNeedle $serverErr 'UPLOAD filename=sample-upload.txt' 40 200
  ...
  if ($log -notmatch 'payload=primary upload payload from sample one') {
