    ...
    switch (name.len) {
        ...
        5 => switch (@as(u40, @bitCast(name[0..5].*))) {
            ...
            asUint("param") => return self.createHtmlElementT(
                ...
                namespace,
                attribute_iterator,
                .{ ._proto = undefined, ._tag_name = String.init(undefined, "param", .{}) catch unreachable, ._tag = .param },
            ),
            asUint("track") => return self.createHtmlElementT(
                Element.Html.Generic,
                namespace,
                attribute_iterator,
                .{ ._proto = undefined, ._tag_name = String.init(undefined, "track", .{}) catch unreachable, ._tag = .track },
            ),
            else => {},
        },
        6 => switch (@as(u48, @bitCast(name[0..6].*))) {
            ...
            asUint("output") => return self.createHtmlElementT(
                ...
                namespace,
                attribute_iterator,
                .{ ._proto = undefined, ._tag_name = String.init(undefined, "output", .{}) catch unreachable, ._tag = .output },
            ),
            asUint("source") => return self.createHtmlElementT(
                Element.Html.Generic,
                namespace,
                attribute_iterator,
                .{ ._proto = undefined, ._tag_name = String.init(undefined, "source", .{}) catch unreachable, ._tag = .source },
            ),
            asUint("object") => return self.createHtmlElementT(
                Element.Html.Generic,
                namespace,
                attribute_iterator,
                .{ ._proto = undefined, ._tag_name = String.init(undefined, "object", .{}) catch unreachable, ._tag = .object },
            ),
            else => {},
        },
