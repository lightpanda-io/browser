            ...
            switch (name.len) {
                1 => switch (name[0]) {
                    ...
                    'b' => return self.createHtmlElementT(
                        ...
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("b"), ._tag = .b },
                    ),
                    'i' => return self.createHtmlElementT(
                        Element.Html.Generic,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("i"), ._tag = .i },
                    ),
                    'q' => return self.createHtmlElementT(
                        Element.Html.Quote,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("q"), ._tag = .quote },
                    ),
                    's' => return self.createHtmlElementT(
                        Element.Html.Generic,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("s"), ._tag = .s },
                    ),
                    else => {},
                },
                2 => switch (@as(u16, @bitCast(name[0..2].*))) {
                    ...
                    asUint("h1") => return self.createHtmlElementT(
                        ...
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("h1"), ._tag = .h1 },
                    ),
                    asUint("h2") => return self.createHtmlElementT(
                        Element.Html.Heading,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("h2"), ._tag = .h2 },
                    ),
                    asUint("h3") => return self.createHtmlElementT(
                        Element.Html.Heading,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("h3"), ._tag = .h3 },
                    ),
                    asUint("h4") => return self.createHtmlElementT(
                        Element.Html.Heading,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("h4"), ._tag = .h4 },
                    ),
                    asUint("h5") => return self.createHtmlElementT(
                        Element.Html.Heading,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("h5"), ._tag = .h5 },
                    ),
                    asUint("h6") => return self.createHtmlElementT(
                        Element.Html.Heading,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("h6"), ._tag = .h6 },
                    ),
                    ...
                    asUint("em") => return self.createHtmlElementT(
                        ...
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("em"), ._tag = .em },
                    ),
                    asUint("dd") => return self.createHtmlElementT(
                        Element.Html.Generic,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("dd"), ._tag = .dd },
                    ),
                    ...
                    asUint("dt") => return self.createHtmlElementT(
                        ...
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("dt"), ._tag = .dt },
                    ),
                    asUint("td") => return self.createHtmlElementT(
                        Element.Html.TableCell,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("td"), ._tag = .td },
                    ),
                    asUint("th") => return self.createHtmlElementT(
                        Element.Html.TableCell,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("th"), ._tag = .th },
                    ),
                ...
                3 => switch (@as(u24, @bitCast(name[0..3].*))) {
                    ...
                    asUint("nav") => return self.createHtmlElementT(
                        ...
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("nav"), ._tag = .nav },
                    ),
                    asUint("del") => return self.createHtmlElementT(
                        Element.Html.Mod,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("del"), ._tag = .del },
                    ),
                    asUint("ins") => return self.createHtmlElementT(
                        Element.Html.Mod,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("ins"), ._tag = .ins },
                    ),
                    asUint("col") => return self.createHtmlElementT(
                        Element.Html.TableCol,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("col"), ._tag = .col },
                    ),
                    ...
                    asUint("sub") => return self.createHtmlElementT(
                        ...
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("sub"), ._tag = .sub },
                    ),
                    asUint("sup") => return self.createHtmlElementT(
                        Element.Html.Generic,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("sup"), ._tag = .sup },
                    ),
                    asUint("dfn") => return self.createHtmlElementT(
                        Element.Html.Generic,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("dfn"), ._tag = .dfn },
                    ),
                    else => {},
                },
                4 => switch (@as(u32, @bitCast(name[0..4].*))) {
                    ...
                    asUint("main") => return self.createHtmlElementT(
                        ...
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("main"), ._tag = .main },
                    ),
                    ...
                    asUint("menu") => return self.createHtmlElementT(
                        ...
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("menu"), ._tag = .menu },
                    ),
                    ...
                    asUint("code") => return self.createHtmlElementT(
                        ...
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("code"), ._tag = .code },
                    ),
                ...
                5 => switch (@as(u40, @bitCast(name[0..5].*))) {
                    ...
                    asUint("aside") => return self.createHtmlElementT(
                        ...
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("aside"), ._tag = .aside },
                    ),
                    ...
                    asUint("thead") => return self.createHtmlElementT(
                        ...
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("thead"), ._tag = .thead },
                    ),
                    asUint("tbody") => return self.createHtmlElementT(
                        Element.Html.TableSection,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("tbody"), ._tag = .tbody },
                    ),
                    asUint("tfoot") => return self.createHtmlElementT(
                        Element.Html.TableSection,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("tfoot"), ._tag = .tfoot },
                    ),
                ...
                6 => switch (@as(u48, @bitCast(name[0..6].*))) {
                    ...
                    asUint("strong") => return self.createHtmlElementT(
                        ...
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("strong"), ._tag = .strong },
                    ),
                    asUint("header") => return self.createHtmlElementT(
                        Element.Html.Generic,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("header"), ._tag = .header },
                    ),
                    asUint("footer") => return self.createHtmlElementT(
                        Element.Html.Generic,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("footer"), ._tag = .footer },
                    ),
                    ...
                    asUint("figure") => return self.createHtmlElementT(
                        ...
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("figure"), ._tag = .figure },
                    ),
                    asUint("hgroup") => return self.createHtmlElementT(
                        Element.Html.Generic,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("hgroup"), ._tag = .hgroup },
                    ),
                    else => {},
                },
                7 => switch (@as(u56, @bitCast(name[0..7].*))) {
                    asUint("section") => return self.createHtmlElementT(
                        ...
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("section"), ._tag = .section },
                    ),
                    asUint("article") => return self.createHtmlElementT(
                        Element.Html.Generic,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("article"), ._tag = .article },
                    ),
                    ...
                    asUint("summary") => return self.createHtmlElementT(
                        ...
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("summary"), ._tag = .summary },
                    ),
                    ...
                    asUint("marquee") => return self.createHtmlElementT(
                        ...
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("marquee"), ._tag = .marquee },
                    ),
                    asUint("address") => return self.createHtmlElementT(
                        Element.Html.Generic,
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("address"), ._tag = .address },
                    ),
                ...
                8 => switch (@as(u64, @bitCast(name[0..8].*))) {
                    ...
                    asUint("colgroup") => return self.createHtmlElementT(
                        ...
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("colgroup"), ._tag = .colgroup },
                    ),
                    ...
                    asUint("noscript") => return self.createHtmlElementT(
                        ...
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("noscript"), ._tag = .noscript },
                    ),
                    else => {},
                },
                10 => switch (@as(u80, @bitCast(name[0..10].*))) {
                    asUint("blockquote") => return self.createHtmlElementT(
                        ...
                        namespace,
                        attribute_iterator,
                        .{ ._proto = undefined, ._tag_name = String.wrap("blockquote"), ._tag = .blockquote },
                    ),
                    else => {},
                },
                else => {},
