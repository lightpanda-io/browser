...
// Engine-neutral persisted-handle alias; Page tracks these in `globals`
// and `temps` without caring about the engine. See qjs/js.zig for the
// quickjs equivalent.
pub const PersistentHandle = v8.Global;

pub fn resetPersistentHandle(handle: *PersistentHandle) void {
    v8.v8__Global__Reset(handle);
}
