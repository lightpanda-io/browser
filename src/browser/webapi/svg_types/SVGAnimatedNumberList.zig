...
pub fn getBaseVal(_: *const SVGAnimatedNumberList, page: *Page) !*SVGNumberList {
    return page._factory.create(SVGNumberList{});
}

pub fn getAnimVal(self: *const SVGAnimatedNumberList, page: *Page) !*SVGNumberList {
