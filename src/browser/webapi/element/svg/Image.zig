...
pub const JsApi = struct {
    ...
    pub const x = bridge.accessor(Image.getX, null, .{});
    pub const y = bridge.accessor(Image.getY, null, .{});
    pub const width = bridge.accessor(Image.getWidth, null, .{});
    pub const height = bridge.accessor(Image.getHeight, null, .{});
    pub const href = bridge.accessor(Image.getHref, null, .{});
};
