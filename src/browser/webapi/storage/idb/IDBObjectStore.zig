...
pub const JsApi = struct {
    ...
    pub const getAllRecords = bridge.function(IDBObjectStore.getAllRecords, .{ .dom_exception = true });
    ...
    pub const deleteIndex = bridge.function(IDBObjectStore.deleteIndex, .{ .dom_exception = true });
