...
every night (00:02 UTC, two hours before the nightly release build) and
commits them to `main`; it can also be run from the Actions tab. It only
runs `orderfile/tools/regen.sh`, which works the same locally:
